...
export function MarketingFinalCta({
  ...
  return (
    <section id="marketing-final-cta" className="py-24">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        <Reveal>
          <div className="relative overflow-hidden rounded-3xl px-8 py-16 text-center text-white shadow-[0_32px_80px_-24px_rgba(23,32,51,0.45)] ring-1 ring-white/10 sm:px-16">
            ...
            />
            <div
              className="pointer-events-none absolute inset-0 bg-linear-to-br from-[#0c1222]/95 via-[#141b2e]/88 to-[#1a1040]/90"
              aria-hidden
            />
