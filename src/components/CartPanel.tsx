...
export function CartPanel({
  ...
  const discountFactor = Math.max(0, 1 - discountPct / 100)
  ...
  return (
    <aside className="flex w-full min-w-0 shrink-0 flex-col border-l border-slate-200 bg-slate-50/80 lg:w-96">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {onCancelTransaction ? (
            <button
              ...
              className="text-sm font-medium text-amber-800 hover:text-amber-900 disabled:cursor-not-allowed disabled:opacity-40"
            >
              Annuler transaction
            </button>
          ) : null}
          <button
            ...
            className="text-sm font-medium text-emerald-700 hover:text-emerald-800 disabled:cursor-not-allowed disabled:opacity-40"
          >
            Vider
          </button>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <p className="mt-1 text-xs text-slate-500">
                    {formatFCFA(line.unitPriceTTC)} × {line.qty} · TVA{' '}
                    {line.vatRatePct ?? DEFAULT_VAT_RATE_PCT} %
                  </p>
                  <p className="mt-0.5 text-xs font-medium text-slate-700">
                    ...
                    <span className="font-mono-nums">
                      {formatFCFA(
                        Math.round(
                          line.unitPriceTTC * line.qty * discountFactor,
                        ),
                      )}
                    </span>
                    {discountPct > 0 ? (
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    <button
                      ...
                      className="flex h-8 w-8 items-center justify-center rounded-md border border-slate-200 bg-slate-50 text-lg leading-none hover:bg-slate-100"
                      aria-label="Diminuer"
                    >
                      −
                    </button>
                    ...
                    <button
                      ...
                      className="flex h-8 w-8 items-center justify-center rounded-md border border-slate-200 bg-slate-50 text-lg leading-none hover:bg-slate-100 disabled:cursor-not-allowed disabled:opacity-40"
